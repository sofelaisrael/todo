...
function App() {
  ...
  const handleAdd = async () => {
    ...
    const newTodo: Todo = {
      ...
      index: todo.length,
      originalIndex: todo.length,
    };

    const addedTodo = await addTodo(newTodo);

    if (addedTodo) {
      setTodo((prevTodos) => [...prevTodos, addedTodo]);
      setTodoTitle("");
      setDueHours("");
      setDueDays("");
      setError("");
          ...
          <div className="todo-list">
            {todo.map((t) => (
              ...
              >
                ...
                <p className="todo-due">{calculateDueTime(t.dueDate)}</p>
      ...
      {showModal && (
        <div className="modal">
          <div className="modal-content">
            ...
            <button className="border p-3 m-3" onClick={handleAdd}>
              Add Task
            </button>
            <button
              className="border p-3 m-3"
